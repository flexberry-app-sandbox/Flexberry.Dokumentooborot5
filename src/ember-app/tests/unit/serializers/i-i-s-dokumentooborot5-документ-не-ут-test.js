...
moduleForModel('i-i-s-dokumentooborot5-документ-не-ут', 'Unit | Serializer | i-i-s-dokumentooborot5-документ-не-ут', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-dokumentooborot5-документ-не-ут',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
