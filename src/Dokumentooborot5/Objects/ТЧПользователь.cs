...
namespace IIS.Dokumentooborot5
{
    ...
    public class ТЧПользователь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Dokumentooborot5.ВходВСистему fВходВСистему;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Dokumentooborot5.ВходВСистему.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ВходВСистему"})]
        public virtual IIS.Dokumentooborot5.ВходВСистему ВходВСистему
        {
            get
            {
                ...
                IIS.Dokumentooborot5.ВходВСистему result = this.fВходВСистему;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧПользовательE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧПользовательE", typeof(IIS.Dokumentooborot5.ТЧПользователь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧПользователь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Dokumentooborot5.DetailArrayOfТЧПользователь members)

        // *** End programmer edit section *** (IIS.Dokumentooborot5.DetailArrayOfТЧПользователь members)
        ...
        /// </summary>
        public DetailArrayOfТЧПользователь(IIS.Dokumentooborot5.ВходВСистему fВходВСистему) : 
                base(typeof(ТЧПользователь), ((ICSSoft.STORMNET.DataObject)(fВходВСистему)))
        {
        }
        
        public IIS.Dokumentooborot5.ТЧПользователь this[int index]
        {
            get
            {
                return ((IIS.Dokumentooborot5.ТЧПользователь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Dokumentooborot5.ТЧПользователь dataobject)
        {
